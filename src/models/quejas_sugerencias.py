...
class QuejasSugerencias(Base):
    ...
    Persona_ID = Column(Integer, ForeignKey('tbb_personas.ID'), nullable=True)  # Relación con TbbPersonas
    ...
    persona = relationship('TbbPersonas', backref='quejas_sugerencias')